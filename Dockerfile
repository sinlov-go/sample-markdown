# This dockerfile uses extends image https://hub.docker.com/sinlov-go/sample-markdown
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/sample-markdown
ARG GO_ENV_ROOT_BUILD_BIN_NAME=sample-markdown
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/sample-markdown/main.go
...
ENTRYPOINT [ "/app/sample-markdown" ]
# CMD ["/app/sample-markdown", "--help"]